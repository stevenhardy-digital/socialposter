...
Route::withoutMiddleware([\Illuminate\Foundation\Http\Middleware\VerifyCsrfToken::class])->group(function () {
    // Connect route needs authentication
    Route::middleware(['auth:sanctum'])->post('/auth/connect/{platform}', [SocialAccountController::class, 'webConnect'])->name('oauth.connect');
